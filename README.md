...
默认音频为 48 kHz 双声道 Opus、20 ms 包。200 路听众按 128 kbps 计算，纯音频约 25.6 Mbps，另需协议开销和余量。慢接收端待发音频超过 16 KiB 时丢弃新音频，持续拥塞 10 秒后断开，避免无界排队。TLS WebSocket 基于 TCP，丢包会影响实时性；真实三网、晚高峰、长期负载与 Steam 双账号需分别验收。
